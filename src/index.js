...
userInput.addEventListener('keyup',()=>{
  //Contar palabras
  textinner[0].innerHTML='Carácteres:'+ analyzer.getCharacterCount(userInput.value)
  textinner[1].innerHTML='Carácteres sin espacios:'+ analyzer.getCharacterCountExcludingSpaces(userInput.value)
...
buttonReset.addEventListener('click',()=>{
  userInput.value=""
  textinner[0].innerHTML='Carácteres:' 
  textinner[1].innerHTML='Carácteres sin espacios:'  
